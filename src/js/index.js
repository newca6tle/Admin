                  ...
                  <ScrollView ref={(scrollView) => { _scrollView = scrollView; }}
                    ...
                    <List>
                      <ListItem>
                        <div className="itemList">
                          <div className="listImage">
                            <img src="../images/dog1.jpg" className="listImageImg"/>
                          </div>
                      ...
                      <ListItem>
                        <div className="itemList">
                          <div className="listImage">
                            <img src="../images/dog5.jpg" className="listImageImg"/>
                          </div>
                          <div className="listText">
                            <div className='labelCSS'>
                              Title Here
                      ...
                      <ListItem>
                        <div className="itemList">
                        <div className="listImage">
                          <img src="../images/dog3.png" className="listImageImg"/>
                        </div>
                          <div className="listText">
                            <div className='labelCSS'>
                              Title Here
                      ...
                      <ListItem>
                        <div className="itemList">
                          <div className="listImage">
                            <img src="../images/dog2.jpg" className="img-circle" width="100%"/>
                          </div>
                          <div className="listText">
                            <div className='labelCSS'>
                              Title Here
